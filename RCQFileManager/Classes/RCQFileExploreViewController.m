...
@interface RCQFileExploreViewController () <UITableViewDelegate, UITableViewDataSource, UIDocumentInteractionControllerDelegate>

@property(nonatomic, strong) UITableView *tableView;

@end

@implementation RCQFileExploreViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (fileObj.isDir) {
        ...
        RCQFileExploreViewController *viewController = [[self.class alloc] init];
